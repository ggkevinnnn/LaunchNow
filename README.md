...
- **🎨 Dual Style Support** — Switch between the fullscreen Launchpad style and the new window style
...
<table>
  ...
  <tr>
    <td align="center">Tahoe Style (Windowed)</td>
    <td align="center">Classic Mode (Fullscreen)</td>
  </tr>
</table>
